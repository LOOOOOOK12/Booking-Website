...
function bookContainer({image, alt, header, price, description, count}) {
    ...
    return (
        <div className='flex flex-col py-10 px-9 rounded-md bg-Grey-2'>
            ...
            <div className='flex flex-col items-center gap-7'>
                ...
                <button 
                    className='text-Puti px-6 py-5 w-full bg-Rich-Black hover:bg-Prussian-Blue ease-in duration-100 font-semibold rounded-md'
                    onClick={count}
                    >
                        Book
                    </button>
