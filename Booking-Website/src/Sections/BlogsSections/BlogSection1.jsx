        ...
        <div className=' py-20 px-16 flex flex-col-reverse gap-8 md:flex md:flex-row md:items-center md:justify-center md:gap-8'>
            <div className=' w-full md:w-2/3 md:text-left'>
                <div className='flex flex-col w-2/3'>
                    <h2 className='h-full text-5xl font-semibold mb-4 text-Rich-Black'>Lorem Ipsum</h2>
            ...
            <img src={Shrine} alt="Shrine" className=' w-[25rem] h-[30rem]  md:w-[35rem] md:h-[40rem] rounded-md'/>
        </div>
    )
}
