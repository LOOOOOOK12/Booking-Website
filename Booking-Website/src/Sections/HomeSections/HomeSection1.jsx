    ...
    return (
        <div id = "home" className='pt-24 px-16 md:flex md:items-center md:justify-center md:gap-28'>
            ...
            <div className='flex-col w-full'>
                ...
                <p className='text-Grey text-2xl mt-3.5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
                    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </p>
                <button className='mt-6 px-11 py-6 text-Puti text-lg font-semibold bg-Rich-Black hover:bg-Prussian-Blue ease-in duration-100 rounded-md'>Read More</button>
            </div>
        </div>
    )
}
